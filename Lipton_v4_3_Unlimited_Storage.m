...
for jaar = 1:2
    ...
    Storage_unlimited = cumsum(-residual_load_curve);
    plot(time_array,Storage_unlimited/1000)
    xlabel('Time')
...
% Save figure as png 
print -dpng -r300 Lipton_v4_3_Unlimited_Storage
