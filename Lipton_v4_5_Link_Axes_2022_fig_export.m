...
h0 = figure('Name','Electricity market NL 2030','pos',[0 0 500 300]); % width and height start and end points
...
for jaar = 1:2
    ...
    %title('')
    save_fig(h0,'Lipton_v4_5_2022_v2');
    print -dpng -r300 Lipton_v4_5_2022_v2
...
% Save figure as png
save_fig(h0,'Lipton_v4_5_16_Juni');

print -dpng -r300 Lipton_v4_5_16_Juni
